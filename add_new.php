...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `bsis`(`Firstname`,`Lastname`,`Middlename`,`Email`) VALUES ('$firstname','$lastname','$middlename','$email')";
...
<body>
   <nav class="navbar navbar-dark justify-content-center fs-3 mb-5" style="background-color:#CCCCFF;">
      CREATE NEW USER
   </nav>
